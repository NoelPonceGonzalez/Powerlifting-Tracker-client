...
export interface SetLog {
  ...
  inputMode?: 'kg' | 'pct';
  /** Vídeo o foto de esa serie (clave en el almacén de medios). */
...
export interface RoutineVersion {
  ...
  /** Ciclo con el que se guardó esta versión. Sin él, cambiar el ciclo descolocaría las semanas ya pasadas. */
  cycleLength?: number;
  weeks: TrainingWeek[];
}
